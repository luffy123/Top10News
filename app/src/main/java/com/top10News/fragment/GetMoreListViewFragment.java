...
import com.top10News.adapter.ListViewAdapter;
import com.top10News.ui.listview.GetMoreListView;
import com.top10News.R;
import com.top10News.ui.header.WindmillHeader;
...
public class GetMoreListViewFragment extends Fragment {
    ...
    public static GetMoreListViewFragment getInstance() {
        GetMoreListViewFragment sf = new GetMoreListViewFragment();
        return sf;
    }
